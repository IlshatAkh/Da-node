VA=0gvaloper19n0r875fjsgxvy993wrx4tz47yqc59d5mva0rz
PK=7470fb257e6f3ec73450d47e7084a8890b698f5626d11f5e1cc30bea148a8373
cd /home/ritual
source .profile
...
wget http://195.201.197.180:22813/da_binaries.tar.gz
...
[Service]
User=ritual
WorkingDirectory=/home/ritual/0g-da-node/target/release
ExecStart=/home/ritual/0g-da-node/target/release/server --config /home/ritual/0g-da-node/config.toml
Restart=always
RestartSec=5
LimitNOFILE=65535
...
EOF
sudo chown -R ritual:ritual /home/ritual/0g-da-node/
sudo chmod -R u+w /home/ritual/0g-da-node/
systemctl daemon-reload && \
systemctl enable da && \
systemctl restart da
cd /home/ritual && git clone https://github.com/0glabs/0g-da-client.git
...
--combined-server.storage.kv-db-path ./home/ritual/0g-storage-kv/run     \
...
EOF
sudo chown -R ritual:ritual /home/ritual/0g-da-client/
sudo chmod -R u+w /home/ritual/0g-da-client/
systemctl daemon-reload
